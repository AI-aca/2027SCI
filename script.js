        ...
        if (totalLimit === 0) {
          ...
          td.innerHTML = `
            <div style="position: relative; width: 120px; height: 24px; background: rgba(255,255,255,0.08); border-radius: 4px; overflow: hidden; border: 1px solid rgba(255,255,255,0.1); margin: 0 auto;">
              ...
              <span style="position: absolute; width: 100%; text-align: center; left: 0; top: 0; line-height: 24px; font-size: 12px; font-weight: 700; color: #ffffff; text-shadow: 0px 1px 2px rgba(0,0,0,0.8); letter-spacing: 0.5px;">
