...
[제2조건 : 출력 형식 (엄격한 템플릿 통제)]
- 서론(예: "제공해주신 자소서를 바탕으로..."), 인사말, 결론 등 어떠한 추가 텍스트도 0.1%도 생성하지 마십시오. 첫 줄부터 오직 예상 질문 세트만 즉각 출력하십시오.
- 1번부터 30번까지 순서대로 번호를 매겨 누락 없이 출력하십시오.
- 각 문항의 제목은 예외 없이 반드시 아래의 템플릿 구조 1줄만 정확히 지켜서 출력하십시오. (글자, 띄어쓰기, 기호 모두 완벽히 통일)
  템플릿: ### 📝 Q[번호]. [자소서 대분류 - 중분류] 소제목
  잘못된 예시 1: ### 📝 Q1. [대분류] 소제목 (절대 금지: 하이픈과 중분류를 생략하지 말 것)
  잘못된 예시 2: ### 📝 Q1. [대분류 - 중분류] (소제목) (절대 금지: 소제목 겉에 소괄호 씌우지 말 것)
- 각 문항의 소제목은 절대 누락하지 말고 반드시 활동 내용을 요약하여 기재하십시오.
...
- 예술(음악, 미술), 체육(운동) 활동과 관련된 질문은 생성하지 않습니다.
[제2조건 : 출력 형식 및 구조 (엄격한 템플릿 통제)]
- 서론(예: "제공해주신 생기부를 바탕으로..."), 인사말, 결론 등 어떠한 추가 텍스트도 0.1%도 생성하지 마십시오. 첫 줄부터 오직 예상 질문 세트만 즉각 출력하십시오.
- 1번부터 15번까지 순서대로 번호를 매겨 질문을 출력하십시오.
- 각 문항의 제목은 예외 없이 반드시 아래의 템플릿 구조 1줄만 정확히 지켜서 출력하십시오. (글자, 띄어쓰기, 기호 모두 완벽히 통일)
  템플릿: ### 📝 Q[번호]. [생기부 대분류 - 중분류] 소제목
  잘못된 예시 1: ### 📝 Q1. [대분류] 소제목 (절대 금지: 하이픈과 중분류를 생략하지 말 것)
  잘못된 예시 2: ### 📝 Q1. [대분류 - 중분류] (소제목) (절대 금지: 소제목 겉에 소괄호 씌우지 말 것)
- 각 문항의 소제목은 절대 누락하지 말고 반드시 활동 내용을 요약하여 기재하십시오.
